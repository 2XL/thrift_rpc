...
class Message(object):
  ...
  thrift_spec = (
    ...
    (5, TType.STRING, 'pubDate', None, None, ), # 5
  )

  def __init__(self, id=None, title=None, author=None, description=None, pubDate=None,):
    self.id = id
    self.title = title
    self.author = author
  ...
  def write(self, oprot):
    ...
    if self.pubDate is not None:
      oprot.writeFieldBegin('pubDate', TType.STRING, 5)
      oprot.writeString(self.pubDate)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
